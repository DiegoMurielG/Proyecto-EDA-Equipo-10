...
void Warehouse_Insert( warehouse_DLL* this, char name[], int amount, int id ){
	...
	if( Warehouse_IsEmpty( this )){
		product_node* prod = new_product(name, stock, id );
		#ifdef DEBUG
		fprintf(stderr,"\n Producto creado");
		#endif
		...
		product_node* prod = new_product(name, amount, id );
		#ifdef DEBUG
		fprintf(stderr,"\n Producto creado");
		#endif
 ...
 */
void Warehouse_Cursor_first( warehouse_DLL* this )
{
...
void Warehouse_Remove( warehouse_DLL* this, int id ){
	Warehouse_busqueda_producto_id(this,id);
...
void Warehouse_PrintStructure( warehouse_DLL* this )
{
   ...
   else
   {
      ...
      {
         printf("\t(%d)->", it->product_id );
         printf("\t(%d)->", it->product_name );
         printf("\t(%d)->", it->product_amount );
      } 
